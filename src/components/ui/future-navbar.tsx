...
// --- FutureButton Component ---

// 🎨 Theme colors — customized for Spicy Bracket (Gold/Orange)
const COLORS = {
  default: {
    stroke1: "#ffaa00",
    fill1: "rgba(255,170,0,0.15)",
    stroke2: "#ffaa00",
    fill2: "rgba(255,170,0,0.05)",
    text: "#ffffff",
  },
  accent: {
    stroke1: "#f97316",
...
const buttonVariants = cva(
  "group font-bold relative px-8 py-2 cursor-pointer transition-all outline-none [&>span]:relative [&>span]:flex [&>span]:items-center [&>span]:justify-center active:scale-95",
  {
    variants: {
      shape: {
        default: "",
