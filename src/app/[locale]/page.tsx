        ...
        <motion.div style={{ y: y1 }} className="relative z-10 flex flex-col items-center text-center space-y-8 max-w-5xl">
          <div className="space-y-4">
            ...
            <motion.h1 initial={{ opacity: 0, y: 30 }} animate={{ opacity: 1, y: 0 }} transition={{ delay: 0.2 }} className="text-8xl md:text-[11rem] font-black tracking-tighter leading-[0.85] uppercase italic">
              Wild <br /><span className="text-[#ffaa00]">Glory</span>
            </motion.h1>
          </div>
        ...
        <div className="flex overflow-hidden gap-6 px-8 md:px-16 group">
          <motion.div className="flex gap-6 shrink-0" animate={{ x: [0, -1000] }} transition={{ duration: 40, repeat: Infinity, ease: "linear" }}>
            {[...recentPlayers, ...recentPlayers].map((player, i) => (
              <div key={`${player.id}-${i}`} className="w-64 h-80 bg-zinc-900 border border-white/5 rounded-[2.5rem] p-8 flex flex-col items-center justify-between group/card hover:border-[#ffaa00]/40 transition-all hover:scale-105">
